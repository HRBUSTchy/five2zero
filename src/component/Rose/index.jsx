      ...
      <svg id="svg" style={{width:"var(--rose)",marginTop:"var(--roseTop)"}} viewBox="0 0 188 264"
        ...
        <defs>
          <radialGradient id="gradient-0" gradientUnits="userSpaceOnUse" cx="-107.308" cy="104.329" r="59.181"
            ...
            <stop offset="1" style={{stopColor: "rgb(141, 41, 41)"}}></stop>
          </radialGradient>
          ...
          <radialGradient id="gradient-6" gradientUnits="userSpaceOnUse" cx="43.926" cy="85.895" r="44.319"
            ...
            <stop offset="0" style={{stopColor: "rgb(56, 16, 16)"}}></stop>
          ...
          <radialGradient id="gradient-8" gradientUnits="userSpaceOnUse" cx="99.231" cy="116.778" r="19.209"
            ...
            <stop offset="0" style={{stopColor: "rgb(51, 13, 13)"}}></stop>
            <stop offset="1" style={{stopColor: "rgb(255, 0, 0)"}}></stop>
          </radialGradient>
          <radialGradient id="gradient-9" gradientUnits="userSpaceOnUse" cx="77.314" cy="119.309" r="20.726"
            ...
            <stop offset="0" style={{stopColor: "rgb(115, 42, 42)"}}></stop>
            <stop offset="1" style={{stopColor: "rgb(255, 0, 0)"}}></stop>
          </radialGradient>
          ...
          <radialGradient id="gradient-11" gradientUnits="userSpaceOnUse" cx="87.793" cy="121.847" r="7.864"
            ...
            <stop offset="0" style={{stopColor: "rgb(255, 0, 0)"}}></stop>
            <stop offset="1" style={{stopColor: "rgb(95, 30, 30)"}}></stop>
          </radialGradient>
          ...
          <radialGradient id="gradient-13" gradientUnits="userSpaceOnUse" cx="34.864" cy="119.976" r="36.699"
            ...
            <stop offset="0" style={{stopColor: "rgb(67, 88, 0)"}}></stop>
            <stop offset="1" style={{stopColor: "rgb(173, 183, 141)"}}></stop>
          </radialGradient>
          <radialGradient id="gradient-14" gradientUnits="userSpaceOnUse" cx="41.572" cy="155.958" r="37.322"
            ...
            <stop offset="0" style={{stopColor: "rgb(64, 78, 18)"}}></stop>
            <stop offset="1" style={{stopColor: "#758d29"}}></stop>
          </radialGradient>
          <radialGradient id="gradient-15" gradientUnits="userSpaceOnUse" cx="107.613" cy="177.189" r="41.15"
            ...
            <stop offset="0" style={{stopColor: "rgb(99, 121, 28)"}}></stop>
            <stop offset="1" style={{stopColor: "rgb(62, 76, 14)"}}></stop>
          </radialGradient>
          <linearGradient id="gradient-16" gradientUnits="userSpaceOnUse" x1="79.232" y1="148.661" x2="79.232"
            y2="267.785" gradientTransform="matrix(0.025831, -0.999666, 0.153237, 0.00396, 43.953685, 274.434674)">
            
            <stop offset="0" style={{stopColor: "#bada55"}}></stop>
            <stop offset="1" style={{stopColor: "rgb(59, 72, 14)"}}></stop>
          </linearGradient>
        ...
        <path
          ...
          <animate repeats="1" id="animate0" begin="indefinite" fill="freeze" calcMode="spline" keySplines="0 .06 0 .97"
            keyTimes="0;1" attributeName="d" dur="12000ms"
        ...
        <path
          ...
          <animate repeats="1" id="animate1" begin="indefinite" fill="freeze" calcMode="spline" keySplines="0 .06 0 .97"
            keyTimes="0;1" attributeName="d" dur="12000ms"
        ...
        <path
          ...
          <animate repeats="1" id="animate2" begin="indefinite" fill="freeze" calcMode="spline" keySplines="0 .06 0 .97"
            keyTimes="0;1" attributeName="d" dur="12000ms"
        ...
        <path
          ...
          style={{stroke: "rgba(255, 0, 0, 0)", fill: "url(#gradient-4)"}}>
          <animate repeats="1" id="animate3" begin="indefinite" fill="freeze" calcMode="spline" keySplines="0 .06 0 .97"
            keyTimes="0;1" attributeName="d" dur="12000ms"
        ...
        <path
          ...
          style={{stroke: "rgba(255, 0, 0, 0)", fill: "url(#gradient-0)"}}>
          <animate repeats="1" id="animate4" begin="indefinite" fill="freeze" calcMode="spline" keySplines="0 .06 0 .97"
            keyTimes="0;1" attributeName="d" dur="12000ms"
        ...
        <path
          ...
          style={{stroke: "rgba(255, 0, 0, 0)", fill: "url(#gradient-1)"}}
          transform="matrix(0.99135, 0.131244, -0.131244, 0.99135, 15.956242, -10.615298)">
          <animate repeats="1" id="animate5" begin="indefinite" fill="freeze" calcMode="spline" keySplines="0 .06 0 .97"
            keyTimes="0;1" attributeName="d" dur="12000ms"
        ...
        <path
          ...
          <animate repeats="1" id="animate6" begin="indefinite" fill="freeze" calcMode="spline" keySplines="0 .06 0 .97"
            keyTimes="0;1" attributeName="d" dur="12000ms"
        ...
        <path
          ...
          <animate repeats="1" id="animate7" begin="indefinite" fill="freeze" calcMode="spline" keySplines="0 .06 0 .97"
            keyTimes="0;1" attributeName="d" dur="12000ms"
        ...
        <path
          ...
          style={{stroke: "rgba(0, 0, 0, 0)", fill: "url(#gradient-2)"}}>
          <animate repeats="1" id="animate8" begin="infinite" fill="freeze" calcMode="spline" keySplines="0 .06 0 .97"
            keyTimes="0;1" attributeName="d" dur="12000ms"
        ...
        <path
          ...
          <animate repeats="1" id="animate9" begin="indefinite" fill="freeze" calcMode="spline" keySplines="0 .06 0 .97"
            keyTimes="0;1" attributeName="d" dur="12000ms"
        ...
        <path
          ...
          style={{stroke: "rgba(23, 11, 11, 0)", fill: "url(#gradient-8)"}}>
